...
src/
  ...
  components/                        SceneFrame, KineticText, AnimatedNumber, BackgroundField
  ...
  data/
    ...
    scene-timings.json               [stage 2 — Claude-authored, committed]
    scenes.json                      legacy fallback for the renderer
